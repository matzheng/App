...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        //$sql = "
        //select * from (
        //select a.tid,a.title, a.detail,a.mid,a.qtypes,ifnull(b.uname,'') as uname,b.face,ifnull(b.product,'') product,ifnull(e.fid,0) as myfav,ifnull(c.favs,0) as favs from az_topic  a left join dede_member b on a.mid=b.mid left join (select tid, count(fid) as favs from az_member_fav group by tid) c on a.tid=c.tid left join (select fid,tid from az_member_fav where mid=".$ck.") e on a.tid=e.tid order by a.tid desc
        ...
        return $this->render('default/index.html.twig',array('result' =>$q->fetchAll(), 'mid'=>$ck, 'page'=>$page));
    }
}
